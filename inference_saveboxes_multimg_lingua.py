...
for img_name in os.listdir(input_dir):
    ...
    if os.path.isfile(img_path):
        ...
        for txt in txts:
                ...
                print(language)
        im_show = draw_ocr_enum(image, boxes, txt_list, scores, font_path='ppocr_img/ppocr_img/fonts/simfang.ttf')
        im_show = Image.fromarray(im_show)
        im_show.save(os.path.join('output_images/cropped_images/', f'{os.path.splitext(img_name)[0]}_result.jpg'))
